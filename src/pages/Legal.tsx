...
export function Risikohinweis() {
  return <Page title="Risikohinweis" kicker="BITTE LIES DAS VOR DEINEM ERSTEN TRADE">
    ...
    <section><h2>Keine Anlageberatung</h2><p>In Saifs Telegram-Gruppe werden Trade-Ideen mit Einstieg, Stop Loss und Ziel geteilt. Diese Beiträge richten sich an alle Mitglieder gleichermaßen und berücksichtigen weder deine finanzielle Situation noch deine Ziele oder deine Erfahrung. Sie sind keine persönliche Anlageberatung und keine Empfehlung, einen bestimmten Trade einzugehen. Ob und in welcher Größe du einen Trade umsetzt, entscheidest ausschließlich du selbst.</p></section>
    ...
    <section><h2>Broker und Vermittlung</h2>
      <p>Die Umsetzung erfolgt über dein eigenes Handelskonto. Als Partner-Broker empfehlen wir VT Markets LLC (registriert in St. Vincent und den Grenadinen, Registernummer 673 LLC 2020). Für das Handelskonto gelten ausschließlich die Bedingungen des Brokers; Ein- und Auszahlungen laufen direkt zwischen dir und dem Broker.</p>
      <p>Wir sind als vermittelnder Partner („Introducing Broker“) für VT Markets tätig und erhalten vom Broker eine Vergütung, die sich am Handelsvolumen der vermittelten Konten bemisst. Für dich entstehen dadurch keine zusätzlichen Kosten. Wir sind weder ein Vertreter noch eine Zweigstelle des Brokers, und wir nehmen keine Kundengelder entgegen, verwalten keine fremden Konten und handeln nicht im Auftrag anderer.</p>
      <p>Das Angebot richtet sich nicht an Personen mit Wohnsitz in Ländern, in denen der Broker seine Dienste nicht anbieten darf – darunter die Vereinigten Staaten von Amerika und der Iran.</p>
      <p className="sx-legal-note">Alle Inhalte dieser Website stammen von uns als vermittelndem Partner. Im Wortlaut des Brokers: <em>„All materials are prepared by the Introducer and VT bears no responsibility for the information and/or materials provided. All claims should be directed to the Introducer. All rights of VT and any affiliated entities trading under the ‚VT‘ trademark, brand or logo are reserved. The ‚VT‘ trademark, brand or logo may not be used without the prior written consent of VT or the relevant rights holder.“</em></p>
    </section>
  </Page>;
}
