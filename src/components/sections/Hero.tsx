        ...
        <div className="max-w-5xl mx-auto text-center py-[20px]">
          ...
          delay: 0.1
            ...
            <span className="relative inline-block">
              ...
              <motion.svg viewBox="0 0 300 12" className="absolute -bottom-1 sm:-bottom-2 left-0 w-full" initial={{
              pathLength: 0
            }} animate={{
              pathLength: 1
            }} transition={{
              ...
              duration: 0.8
                ...
                <motion.path d="M 0 6 Q 75 0, 150 6 Q 225 12, 300 6" fill="none" stroke="hsl(45 93% 58%)" strokeWidth="3" strokeLinecap="round" initial={{
                pathLength: 0
              }} animate={{
                pathLength: 1
              }} transition={{
          ...
          duration: 0.6,
          delay: 0.3
        }} className="flex justify-center px-4 sm:px-0 py-[30px]">
          ...
          delay: 0.4
            ...
            <Link to="/quiz" className="w-full sm:w-auto">
              <Button variant="hero" size="lg" className="w-full sm:w-auto group relative overflow-hidden text-sm sm:text-base" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
                <motion.span className="absolute inset-0 bg-gradient-to-r from-primary via-primary/80 to-primary" animate={{
