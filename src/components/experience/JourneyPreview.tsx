...
const fields = [
  { label: 'Einstieg', value: '2.518,10', text: 'Der Einstieg beschreibt den vorgesehenen Preis oder Bereich. Prüfe die genaue Anweisung und den aktuellen Kurs, bevor du einen Trade übernimmst.', orderText: 'Prüfe zuerst Kurs und Orderart: Eine Marktorder wird zum verfügbaren Kurs ausgeführt. Bei einer Pending Order legst du eine Preisbedingung fest. Die Einstiegsangabe ist kein zugesicherter Ausführungspreis.' },
  { label: 'Stop Loss', value: '2.520,40', text: 'Der Stop Loss bezeichnet die vorgesehene Ausstiegsmarke bei einem ungünstigen Verlauf. Er ist keine Garantie für einen bestimmten Ausführungspreis.', orderText: 'Die Stop-Loss-Angabe gehört in das entsprechende Feld deiner Order. Gleiche Instrument, Richtung und Wert mit der Nachricht ab. Positionsgröße und Risiko bestimmst du selbst.' },
  { label: 'Ziel', value: '2.517,05', text: 'Das Ziel beschreibt den geplanten Ausstieg bei günstigem Verlauf. Ob der Markt diesen Preis erreicht, steht nicht fest.', orderText: 'Die Zielangabe gehört in das Take-Profit-Feld deiner Order. Gleiche Instrument, Richtung und Wert mit der Nachricht ab. Positionsgröße und Risiko bestimmst du selbst.' },
];
const previews = [
