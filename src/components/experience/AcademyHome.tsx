    ...
    <section className="sh-hero sh-home-hero">
      ...
      <div className="sh-layout sx-wrap">
        <div className="sh-copy">
          ...
          <h1>Trading lernen.<br/><em>Mit Saif.</em></h1>
          <p>Von den ersten Grundlagen zu deinem eigenen Trading-System. Entdecke den Weg, der zu dir passt.</p>
          <div className="sh-actions"><button className="sx-button sx-button-gold" onClick={()=>play(0)}><Play size={16} fill="currentColor"/>Saif kennenlernen <ArrowUpRight size={18}/></button><a href="#lernweg">Dein Lernweg <ArrowDown size={17}/></a></div>
          <div className="sh-footnote"><span>01 — GRUNDLAGEN</span><span>02 — STRATEGIE</span><span>03 — PRAXIS</span><span>04 — MEISTERSCHAFT</span></div>
        </div>
        <SaifIntro onPlay={()=>play(0)} paused={video!==null}/>
      </div>
      <div className="sh-bottom sx-wrap"><span>DEIN EINSTIEG BEGINNT MIT EINEM GESPRÄCH.</span><Link to="/signale">Du suchst Saifs Trades? <ArrowUpRight size={15}/></Link></div>
    </section>
    <section className="sh-transition" aria-label="Dein Weg. Dein Tempo."><span aria-hidden="true">DEIN WEG.</span><span aria-hidden="true">DEIN TEMPO.</span><div>VIER SCHRITTE. EIN EIGENER WEG.<ArrowDown size={22}/></div></section>
    <AcademyJourney/>
