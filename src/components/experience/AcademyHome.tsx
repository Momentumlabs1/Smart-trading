    ...
    <section className="sx-hero-track" ref={hero}>
      ...
      <div className="sx-hero-layout sx-wrap">
        <div className="sx-hero-copy">
          ...
          <div className="sx-hero-ctas"><a href="#lernweg" className="sx-button sx-button-gold">Deinen Weg entdecken <ArrowDown size={18}/></a><Link to="/signale" className="sx-link-arrow">Saifs Trades <ArrowUpRight size={18}/></Link></div>
