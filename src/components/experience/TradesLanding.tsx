  ...
  return <div className="sx-page tr-page" ref={root}>
    ...
    <main id="main">
      ...
      <section className="tr-faq sx-wrap"><div className="tr-section-top"><span className="tr-eyebrow">GUT ZU WISSEN</span><h2>Deine Fragen.</h2></div><div className="tr-faq-list">
        ...
        <details><summary>Was kostet der Zugang?<ChevronDown size={18}/></summary><p>Der Zugang kostet keine Gebühr. Du eröffnest ein eigenes Handelskonto bei unserem Partner-Broker VT Markets und zahlst ab 100 $ ein. Das Geld liegt auf deinem Konto und gehört dir. Wir erhalten für die Vermittlung eine Vergütung vom Broker; für dich entstehen dadurch keine zusätzlichen Kosten.</p></details>
